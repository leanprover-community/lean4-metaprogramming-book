...
```
-- elab <syntax> : <syntax category> => <defn>
elab "admit" : tactic => ...
```
...
##### Full Code Listing for `custom_sorry`
...
```lean
theorem trivial_1 (H1: 1 = 1) (H2: 2 = 2): 2 = 2 := by {
  custom_trivial
}
...
Mext, we access the list of hypotheses, which are stored in a data structure
...
##### Full Code Listing for `custom_trivial`
